...
public class Main {
    ...
    private void initialize() {
        frame = new JFrame();
        frame.setBounds(100, 100, 1070, 755);
...
//        JLabel label_1 = new JLabel("成绩管理系统");
...
//        label_1.setFont(new Font("幼圆", Font.PLAIN, 45));
        ...
        panel_2.setBounds(0, 0, 1070, 663);
...
//        JLabel label_2 = new JLabel(Login.user_name.getText().trim() + "，你好");
//        label_2.setFont(new Font("微软雅黑", Font.PLAIN, 20));
//        label_2.setBounds(672, 51, 248, 47);
//        panel_1.add(label_2);

        title = new Vector<String>(Arrays.asList("序号", "学号", "姓名", "高数", "线代", "英语","平均分","总分"));
